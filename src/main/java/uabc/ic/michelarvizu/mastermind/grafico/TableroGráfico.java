...
public class TableroGráfico {
    ...
    /**
     * Constructor de la clase TableroGráfico. 
     * Crea el tablero gráfico de acuerdo a los argumentos recibidos.
     */
    ...
    /**
     * Crea en el tablero los círculos que representan los pines. 
     * También muestra los colores que se pueden utilizar en el juego.
     */
    ...
    public void setColoresDeIntento(int tamaño, int intento, ArrayList <Color> combinación)
    {
        for(int i=0; i<tamaño; i++)
        {
    ...
    public void setColoresDeCombinaciónSecreta(int tamaño, ArrayList <Color> combinación)
    {
        for(int i=0; i<tamaño; i++)
        {
