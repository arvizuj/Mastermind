...
public class Canvas
{
    ...
    {
        this(title, 350, 550, Color.white);
    }
    ...
    public void drawChar(char letra, int x, int y)
    {
        String texto = letra+"";
    ...
    public void escribir(String text, int x, int y)
    {
        drawString(text, x, y);
    }
  
    public void drawString(String text, int x, int y, Color elColor)
    {   
        graphic.setColor(elColor);
        graphic.drawString(text, x, y);   
        canvas.repaint();
    }
    /**
